      ...
      <div className="max-h-[350px] w-full relative rounded-t-[8px]">
        <div className="absolute h-[26px] text-[13px] items-center align-middle font-normal bg-white rounded-[6px] px-[10px] right-4 top-2">
          <button
            ...
            className="flex gap-[8px] align-middle items-center mt-[4px]"
          >
            Показать фон
            <ChevronDown size={13} />
          </button>
        ...
        <Image
          className={cn(
            "max-h-[350px] w-full object-cover rounded-t-[8px]",
            {
              "max-h-[42px]  w-full object-cover rounded-t-[8px]":
                active === true,
            },
            className
          )}
      ...
      <div className="bg-white rounded-b-[8px]">
        <div className="flex justify-between items-center px-4 py-3">
          ...
          <button className="rounded-[6px] text-[13px] font-normal bg-[#0000000c] h-[26px] block align-items">
            <Link
              className="px-[10px]  flex gap-2 font-medium items-center"
              href="/settings"
            >
          ...
          <ul className="flex text-[15px] gap-4 items-center ">
            {userAbb.map((item) => (
              <li
                ...
                className={cn(
                  "cursor-pointer py-[12px] text-[#212529] opacity-[.8px]",
                  {
                    " transition-all duration-800 ease-in-out relative after:absolute  after:-bottom-[0px] after:border-b-[3px] after:-left-[0px]   after:w-full after:h-[3px] after:border-b-[#ffab40] after:rounded-t-[3px]":
