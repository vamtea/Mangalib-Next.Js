...
export const TagsDrawerHeader: React.FC<Props> = ({ className }) => {
  return (
    <div className={className}>
      <div className="flex justify-between px-[12px] h-10">
        <div className="flex gap-[10px] font-semibold items-center text-[14px]">
          <ArrowLeft size={14} /> Теги
        </div>
      ...
      <div className="flex justify-between py-2 px-3">
        ...
        <div>
          {/* <CircleHelp />  */}
          <div className="w-[26px] h-[26px] border-[50%] bg-[#007deb1e] rounded-full flex items-center justify-center text-[#007deb]">?</div>
        </div>
      </div>
        <div className="w-full bg-slate-200 h-[1px] " />
    </div>
